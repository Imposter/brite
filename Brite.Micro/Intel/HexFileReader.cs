...
namespace Brite.Micro.Intel
{
    ...
    {
        private IEnumerable<string> _hexRecordLines;
        ...
        public HexFileReader(byte[] bytes, int memorySize)
        {
        ...
        {
            return ReadHexFile(_hexRecordLines, _memorySize);
        }
