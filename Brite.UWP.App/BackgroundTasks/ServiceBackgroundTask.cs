...
namespace Brite.UWP.App.BackgroundTasks
{
    public sealed class ServiceBackgroundTask : BackgroundTask
    {
        ...
        public override Task RunAsyncInternal(IBackgroundTaskInstance taskInstance)
        {
            ...
            return Task.Run(() =>
            {
                ...
                ThreadPoolTimer.CreatePeriodicTimer(new TimerElapsedHandler(SampleTimerCallback), TimeSpan.FromSeconds(1)); // TODO: Tick Timer for plugins
            });
        }
